...
![WPS 文档朗读助手](packaging/windows/assets/app-logo.png)
...
| --- | --- | --- | --- |
| Windows | x86/x64 Windows 10/11 | WPS Office 2019 或更高版本，推荐最新稳定版 | wps-read-aloud-comate_1.1.0_windows.exe |
| 银河麒麟 | x64 银河麒麟 V10 及以上 | WPS Office 2019 for Linux 或更高版本，推荐最新稳定版 | wps-read-aloud-comate_1.1.0_amd64.deb |
| 银河麒麟 | ARM64 银河麒麟 V10 及以上 | WPS Office 2019 for Linux 或更高版本，推荐最新稳定版 | wps-read-aloud-comate_1.1.0_arm64.deb |
| UOS | x64 UOS V20 | WPS Office 2019 for Linux 或更高版本，推荐最新稳定版 | cn.wps-read-aloud-comate_1.1.0_amd64.deb |
| UOS | ARM64 UOS V20 | WPS Office 2019 for Linux 或更高版本，推荐最新稳定版 | cn.wps-read-aloud-comate_1.1.0_arm64.deb |
...
| 目标 | 命令或操作 |
| --- | --- |
| x86/x64 Windows 10/11 | 运行 dist/wps-read-aloud-comate_1.1.0_windows.exe |
| x64 银河麒麟 V10 及以上 | sudo dpkg -i dist/wps-read-aloud-comate_1.1.0_amd64.deb |
| ARM64 银河麒麟 V10 及以上 | sudo dpkg -i dist/wps-read-aloud-comate_1.1.0_arm64.deb |
| x64 UOS V20 | sudo dpkg -i dist/cn.wps-read-aloud-comate_1.1.0_amd64.deb |
| ARM64 UOS V20 | sudo dpkg -i dist/cn.wps-read-aloud-comate_1.1.0_arm64.deb |
