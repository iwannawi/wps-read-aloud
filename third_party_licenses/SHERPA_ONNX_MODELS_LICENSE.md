...
本项目未修改上述模型文件，仅作为离线运行资源随安装包分发到本项目专用语音模型目录。x64/ARM64 银河麒麟 V10 及以上安装包路径为 “/opt/wps-read-aloud-comate/voices/sherpa”，x64/ARM64 UOS V20 安装包路径为 “/opt/apps/cn.wps-read-aloud-comate/files/voices/sherpa”，x86/x64 Windows 10/11 安装包路径为安装目录下的 “voices\sherpa”。
