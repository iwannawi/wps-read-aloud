param(
  ...
  [string]$Tag = "v1.0.15-20260516"
)

$ErrorActionPreference = "Stop"

$Root = Resolve-Path (Join-Path $PSScriptRoot "..")
$Deb = Join-Path $Root "dist\wps-read-aloud-zhangjingyao_1.0.15_arm64.deb"
$ShaFile = Join-Path $Root "dist\wps-read-aloud-zhangjingyao_1.0.15_arm64.deb.sha256"
$ReleaseNotes = Join-Path $Root "RELEASE_NOTES.md"
$Log = Join-Path $Root "dist\github-release-v1.0.15-20260516.log"
