...
GitHub 推送和 Release 发布使用仓库内的常驻脚本，不再为每个版本生成临时脚本：
    ...
    .\scripts\push_github.ps1 -Tag v1.0.37-20260520
    .\scripts\publish_github_release.ps1 -Version 1.0.37 -ReleaseDate 20260520
...
当前交付包命名示例：
    ...
    wps-read-aloud-comate_1.0.37_windows.exe
    wps-read-aloud-comate_1.0.37_amd64.deb
    wps-read-aloud-comate_1.0.37_arm64.deb
    cn.wps-read-aloud-comate_1.0.37_amd64.deb
    cn.wps-read-aloud-comate_1.0.37_arm64.deb
