...
| 次版本 | 新平台、新安装包类型、重要能力升级、交付规范升级 | 1.1.1 |
| 修订号 | 缺陷修复、文案优化、兼容性小改 | 1.1.1 |

本项目从 1.1.1 开始按此规则发布。标签格式为：

    v1.1.1-20260520

Release 名称格式为：

    wps-read-aloud-comate 1.1.1 20260520
...
推送：
    ...
    .\scripts\push_github.ps1 -Tag v1.1.1-20260520

发布 Release：

    .\scripts\publish_github_release.ps1 -Version 1.1.1 -ReleaseDate 20260520
...
正式发布必须同时交付：
    ...
    wps-read-aloud-comate_1.1.1_windows.exe
    wps-read-aloud-comate_1.1.1_amd64.deb
    wps-read-aloud-comate_1.1.1_arm64.deb
    cn.wps-read-aloud-comate_1.1.1_amd64.deb
    cn.wps-read-aloud-comate_1.1.1_arm64.deb
